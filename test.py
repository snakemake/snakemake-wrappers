...
def test_plink_preprocess():
    run(
        "bio/plink/preprocess", ["snakemake", "--cores", "1", "--use-conda", "-F"],
    )
...
def test_plink_model():
    run(
        "bio/plink/model", ["snakemake", "--cores", "1", "--use-conda", "-F"],
    )


def test_plink_logistic():
    run(
        "bio/plink/logistic", ["snakemake", "--cores", "1", "--use-conda", "-F"],
    )


def test_plink_linear():
    run(
        "bio/plink/linear", ["snakemake", "--cores", "1", "--use-conda", "-F"],
    )
