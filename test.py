...
def test_macs2_callpeak():
    run(
        ...
        [
            ...
            "--cores",
            "1",
            "results/basename_peaks.xls",
            "results/basename_peaks.broadPeak",
            "results/basename_peaks.gappedPeak",
            "results/basename_treat_pileup.bdg",
            "results/basename_control_lambda.bdg",
            "--use-conda",
            "-F",
        ],
    )
