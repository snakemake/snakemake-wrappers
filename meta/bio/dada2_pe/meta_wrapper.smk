...
rule dada2_quality_profile_pe:
    ...
    wrapper:
        "v9.4.0/bio/dada2/quality-profile"
...
rule dada2_dereplicate_fastq:
    ...
    wrapper:
        "v9.4.0/bio/dada2/dereplicate-fastq"
...
rule dada2_sample_inference:
    ...
    threads: 1 # set desired number of threads here
    wrapper:
        "v9.4.0/bio/dada2/sample-inference"
...
rule dada2_remove_chimeras:
    ...
    threads: 1 # set desired number of threads here
    wrapper:
        "v9.4.0/bio/dada2/remove-chimeras"
...
rule dada2_collapse_nomismatch:
    ...
    threads: 1 # set desired number of threads here
    wrapper:
        "v9.4.0/bio/dada2/collapse-nomismatch"
...
rule dada2_assign_taxonomy:
    ...
    threads: 1 # set desired number of threads here
    wrapper:
        "v9.4.0/bio/dada2/assign-taxonomy"
