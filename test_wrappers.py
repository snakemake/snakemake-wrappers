...
def test_nanosim_genome(run):
    run(
        ...
        [
            ...
            "--cores",
            "1",
            "results/nanosim/genome/brca2.human_giab_hg002_sub1M_kitv14_dorado_v3.2.1/training.simulated_reads.fq",
            "results/nanosim/genome/brca2.human_giab_hg002_sub1M_kitv14_dorado_v3.2.1/training.simulated_errors.txt",
            "results/nanosim/genome/brca2.human_giab_hg002_sub1M_kitv14_dorado_v3.2.1/training.simulated_reads.unaligned.fq",
            "--use-conda",
            "-F",
        ],
    )
...
def test_nanosim_transcriptome(run):
    run(
        ...
        [
            ...
            "--cores",
            "1",
            "results/nanosim/transcriptome/brca2.human_NA12878_cDNA-rel2_guppy_v3.2.2/training.simulated.fq",
            "results/nanosim/transcriptome/brca2.human_NA12878_cDNA-rel2_guppy_v3.2.2/training.simulated.errors.txt",
            "results/nanosim/transcriptome/brca2.human_NA12878_cDNA-rel2_guppy_v3.2.2/training.simulated_reads.unaligned.fq",
            "--use-conda",
            "-F",
        ],
    )
...
def test_nanosim_metagenome(run):
    run(
        ...
        [
            ...
            "--cores",
            "1",
            "results/nanosim/metagenome/brca2.metagenome_ERR3152366_Log_v3.2.2/training/config/sample_x.abundances.tsv",
            "results/nanosim/metagenome/brca2.metagenome_ERR3152366_Log_v3.2.2/training/config/sample_x.dna_type_list.tsv",
            "results/nanosim/metagenome/brca2.metagenome_ERR3152366_Log_v3.2.2/training/config/sample_x.reference_genomes_list.tsv",
            "results/nanosim/metagenome/brca2.metagenome_ERR3152366_Log_v3.2.2/training/simulated/sample_x.simulated_errors.txt",
            "results/nanosim/metagenome/brca2.metagenome_ERR3152366_Log_v3.2.2/training/simulated/sample_x.simulated_reads.fa",
            "--use-conda",
            "-F",
        ],
    )
