...
def setup_module():
    ...
    subprocess.check_call("source activate star-env; STAR --genomeDir index --genomeFastaFiles genome.fasta --runMode genomeGenerate", shell=True, executable="/bin/bash")
