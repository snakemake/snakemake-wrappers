...
process_r1 = "mv {outdir}/{prefix}_trim_R1.fq {out}".format(outdir=outdir, prefix=read_prefix, out=intermediate_output_r1)
if snakemake.output.r1.endswith(".gz"):
    process_r1 = "{process_r1} && gzip -9 {out}".format(process_r1=process_r1,out=intermediate_output_r1)

process_r2 = ""
if snakemake.input.get("r2", ""):
    process_r2 = "&& mv {outdir}/{prefix}_trim_R2.fq {out}".format(outdir=outdir, prefix=read_prefix, out=intermediate_output_r2)
