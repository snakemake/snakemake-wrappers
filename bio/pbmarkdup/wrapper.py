...
if "--rmdup" in extra and dup_file:
    raise ValueError("Cannot specify --rmdup and output duplicates to file using dup_file output option.")

shell("pbmarkdup --num-threads {snakemake.threads} {extra} {inputs} {dedup_file} {dup_file} {log}")
